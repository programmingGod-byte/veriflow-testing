...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center relative overflow-hidden">
      ...
      />
      <motion.div 
        className="absolute bottom-20 right-20 w-80 h-80 bg-cyan-300 rounded-full mix-blend-multiply filter blur-xl opacity-20"
        animate={{ 
          scale: [1, 1.3, 1],
          x: [0, -30, 0],
          y: [0, 30, 0],
      ...
      >
        ...
        >
          ...
          <div className="flex relative">
            <motion.button
              className={`flex-1 py-5 text-center font-medium relative z-10 ${activeTab === 'signin' ? 'text-blue-600' : 'text-gray-600'}`}
            ...
            <motion.button
              className={`flex-1 py-5 text-center font-medium relative z-10 ${activeTab === 'signup' ? 'text-blue-600' : 'text-gray-600'}`}
              variants={tabVariants}
