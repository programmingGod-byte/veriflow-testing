      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">Empower Communities with Early Flood Detection</p>
            <p className="text-gray-400 mb-6">The comprehensive flood monitoring solution for keeping communities safe and informed.</p>
            
            {/* Social Media */}
            <div className="flex gap-4">
              <motion.a 
                href="https://www.linkedin.com/company/visiflow/" 
                target="_blank" 
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/realtime-data" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Real-time Data
                </Link>
              </li>
              {/* <li>
                <Link href="/3d-model" className="text-gray-400 hover:text-blue-400 transition-colors">
                  3D Model
                </Link>
              </li> */}
              <li>
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to get updates on new features and flood detection improvements.
            </p>
            ...
            <form className="mb-6">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-800 text-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  required
                />
                <button
                  type="submit"
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400">admin@visiflow.com</span>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-gray-400">+91 7488011618</span>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span className="text-gray-400">Kamand, Mandi, Himachal Pradesh, India</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Visiflow. All rights reserved.
          </p>
          <div className="flex gap-6">
            <Link href="/privacy" className="text-gray-500 text-sm hover:text-blue-400 transition-colors">
              Privacy
            </Link>
            <Link href="/terms" className="text-gray-500 text-sm hover:text-blue-400 transition-colors">
              Terms
            </Link>
          </div>
        </div>
